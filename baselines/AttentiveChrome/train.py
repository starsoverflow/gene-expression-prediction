...
parser.add_argument('--cell_type', type=str, default='Cell_ESC_H05', help='cell type 1')
parser.add_argument('--save_root', type=str, default='./Results/', help='where to save')
parser.add_argument('--data_root', type=str, default='../../processed_data/', help='data location')
parser.add_argument('--gpuid', type=int, default=0, help='CUDA gpu')
parser.add_argument('--gpu', type=int, default=0, help='CUDA gpu')
parser.add_argument('--n_hms', type=int, default=2, help='number of histone modifications')
...
if(args.test_on_saved_model==False):
	for epoch in range(0, args.epochs):
		...
		if(valid_avgAUC >= best_valid_avgAUC):
			...
			model.type(dtype)
		# all the auc variables here are aupr because I exchange them in evalute.py!
		print("Epoch:",epoch)
		print("train avgAUpr:",train_avgAUC)
		print("valid avgAUpr:",valid_avgAUC)
		print("test avgAUpr:",test_avgAUC)
		print("best valid avgAUpr:", best_valid_avgAUC)
		print("best test avgAUpr:", best_test_avgAUC)

 
	print("\nFinished training")
	print("Best validation avgAUpr:",best_valid_avgAUC)
	print("Best test avgAUpr:",best_test_avgAUC)
